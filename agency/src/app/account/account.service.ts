...
export class AccountService {
  ...
  //   return this.http.post(`${CONFIG.site_url}/users/update-tasker-profile`, data);
  // }
  public updatetaskerprofile(data): Observable<any> {
  ...
  public SaveAddress(data):  Observable<any> {
    return this.http.post(`${CONFIG.site_url}/users/saveaddress`,data);
  }
  public DeleteAddress(data):  Observable<any> {
    return this.http.post(`${CONFIG.site_url}/users/deleteaddress`,data);
  }
  public addressList(data):  Observable<any> {
    return this.http.post(`${CONFIG.site_url}/users/addresslist`,data);
  }
}
