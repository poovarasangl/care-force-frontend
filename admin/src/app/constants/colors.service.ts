...
export class Colors {
	public static getColors() {
		...
		return {
			...
			themeColor2: rootStyle.getPropertyValue('--orange').trim(),
			themeColor3: rootStyle.getPropertyValue('--green').trim(),
			...
			redcolor : rootStyle.getPropertyPriority('--red-color').trim()
		};
	}
}
