...
@Component({
  selector: 'app-languagemanageadd',
  templateUrl: './languagemanageadd.component.html',
  styleUrls: ['./languagemanageadd.component.scss']
})
export class LanguagemanageaddComponent implements OnInit {
