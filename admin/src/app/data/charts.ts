...
export const lineChartData = {
  ...
  datasets: [
    ...
    },
    {
      ...
      pointBackgroundColor: Colors.getColors().separatorColor,
      pointBorderColor: Colors.getColors().themeColor2,
      pointHoverBackgroundColor: Colors.getColors().themeColor2,
      pointHoverBorderColor: Colors.getColors().separatorColor,
      pointRadius: 4,
      pointBorderWidth: 2,
      pointHoverRadius: 6,
      borderWidth: 2,
...
export const radarChartData = {
  ...
  labels: ['Admin Earnings', 'Service Tax', 'Site Earnings']
};

export const pieChartData = {
  labels: ['Admin Earnings', 'Site Earnings', 'Service Tax'],
  datasets: [
    {
      label: '',
      borderColor: [Colors.getColors().themeColor1, Colors.getColors().themeColor2, Colors.getColors().themeColor3],
